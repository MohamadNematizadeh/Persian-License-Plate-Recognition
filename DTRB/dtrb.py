...
class DTRB:
    ...
    def load_data(self,imag_folder):
        AlignCollate_demo = AlignCollate(imgH=opt.imgH, imgW=opt.imgW, keep_ratio_with_pad=opt.PAD)
        demo_data = RawDataset(root=imag_folder, opt=opt)  # use RawDataset
    ...
    def predict(self,imag_folder):
        self.load_data(imag_folder)
        self.model.eval()
        with torch.no_grad():
...
if __name__ == "__main__":
    plate_rec =DTRB("../weigths/dtrb-recoginzer/best_accuracy.pth")
